...
public class PersonDao {
	...
	//users are saved in "./Data/users.txt", we can edit that file, admins are saved in 
	//admins are saved in "./Data/admins.txt", the program doesn't allow you to edit it, you
	...
	private boolean saveUsersToFile(){
		...
		try {
			out = new BufferedWriter(new OutputStreamWriter(
					new FileOutputStream("./Data/users.txt"), "UTF-8"));
			String line;
